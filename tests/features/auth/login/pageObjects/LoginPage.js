...
class LoginPage extends BasePage {
    ...
    async login(username, password) {
        ...
        try {
            ...
            await this.page.waitForSelector(this.selectors.emailInput, { state: 'visible', timeout: 30000 });
            ...
            await this.page.waitForSelector(this.selectors.passwordInput, { state: 'visible', timeout: 30000 });
