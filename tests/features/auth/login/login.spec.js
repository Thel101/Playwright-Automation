...
test.describe('Azure AD B2C Authentication', () => {
    ...
    test('should handle both valid and invalid login attempts', async ({ page, context }) => {
        ...
        try {
            ...
            await page.screenshot({ path: 'tests/features/auth/login/screenshots/invalid-login-error.png' });
        }
        ...
        try {
            ...
            await page.screenshot({ path: 'tests/features/auth/login/screenshots/valid-login-error.png' });
            throw error;
        }
    });
});
